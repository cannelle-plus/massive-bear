...
var GameHandler = function(projections, commands)
{
    ...
    this.getGames = function(req, res, session) {
       var options = {
        root: './www-root/',
        dotfiles: 'deny',
        headers: {
    ...
    this.createGame = function(req, res, session) {
    ...
    /* POST to join game */
    this.joinGame = function(req, res, session) {
    ...
    this.abandonGame = function(req, res, session) {
    ...
    this.cancelGame = function(req, res, session) {
